...
public class PlayerController : MonoBehaviour
{
	...
	public Animator ExhaustLeft;
	public Animator ExhaustRight;
    ...
    void FixedUpdate()
    {
        ...
        //not the overall netforce
            ...
            if (Input.GetKey("a"))//left
            {
				...
				ExhaustLeft.SetBool("Left", false);
				ExhaustRight.SetBool("Right", true);
            }
            if (Input.GetKey("d"))//right
            {
				...
				ExhaustLeft.SetBool("Left", true);
				ExhaustRight.SetBool("Right",false);
            }
