...
public class CameraMovement : MonoBehaviour {
    ...
    void LateUpdate()
    {
        ...
        transform.Translate(new Vector3(0, 0, -movement.velocity.magnitude/ forwardM));
        float x = movement.velocity.x;
        float y = movement.velocity.y;
        transform.rotation = new Quaternion(-y / xRot, x / yRot, x / zRot, Cube.transform.rotation.w);
